...
caption(sztable) <- "Table: \\#tab:sz_model Regression output for the sum to zero model of Kangaroo Rat density."
sztable
```
...
There is another thing that is easy to do with the sum to zero estimates that is harder with the mixed model. We can ask if each individual plot is different from the population average! That is the p value in Table \@ref(tab:sz_model). 
